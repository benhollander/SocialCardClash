    ...
    <div className="max-w-sm mx-auto min-h-screen bg-white shadow-lg">
      <div className="p-6 min-h-screen flex flex-col justify-center">
        <div className="mb-8">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Join Room</h2>
          <p className="text-gray-600">Enter the room code from your friend</p>
        </div>
        ...
        <div className="mb-8">
          ...
          <Input
            ...
            placeholder="ABC123"
            className="w-full text-center text-2xl font-bold tracking-widest bg-gray-50 border-2 border-gray-200 rounded-2xl py-4 px-6 focus:border-primary focus:outline-none uppercase"
            maxLength={6}
          />
        </div>
